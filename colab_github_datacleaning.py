...
# 📌 Colab: Load Dataset dari GitHub + Data Cleaning (Missing Value)
...
> ✅ Cara pakai: ganti nilai `GITHUB_FILE_URL` pada Cell 3 dengan link file dataset kamu di GitHub (boleh link `github.com/.../blob/...` atau link `raw.githubusercontent.com/...`).
...
def basic_cleaning(df: pd.DataFrame) -> pd.DataFrame:
    ...
    if len(missing_count) == 0:
        print("Tidak ada missing value terdeteksi ✅")
    else:
...
print("✅ Data cleaning selesai. Shape akhir:", df_clean.shape)
...
print("✅ Tersimpan: data_bersih.csv")
...
if TARGET_COL == "":
    print("⚠️ TARGET_COL masih kosong. Isi TARGET_COL jika ingin training model.")
else:
...
# Judul dashboard
st.title("Dashboard Data Saya")

# Load dataset
df = pd.read_csv("https://raw.githubusercontent.com/nanocassander-lab/Bekasmotorku/refs/heads/main/motor_second.csv")  # ganti sesuai datasetmu

# Tampilkan tabel
st.subheader("Tabel Data")
st.dataframe(df)

# Pilihan kolom untuk plot
